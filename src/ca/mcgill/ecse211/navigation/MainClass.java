...
public class MainClass {
	...
	public static void main(String[] args) throws OdometerExceptions {
		...
		Driver driver = new Driver(leftMotor, rightMotor, TRACK, WHEEL_RAD);
		
		UltrasonicLocalizer usLocalizer = new UltrasonicLocalizer(driver);

		
		LightLocalizer lightLocalizer = new LightLocalizer(driver);
		
		Navigation nav = new Navigation(driver, TRACK, WHEEL_RAD);
